...
if getattr(Globals.currGameScene, "CatchRateFactor", 0) > 1:
	Globals.currGameScene.__CatchRateFactor = Globals.currGameScene.CatchRateFactor
	
if getattr(Globals.currGameScene, "__CatchRateFactor", None) != None:
	Globals.currGameScene = Globals.currGameScene.__CatchRateFactor
